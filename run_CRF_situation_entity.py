...
if __name__ == "__main__":
    ...
    for parameters in parameters_list:
        ...
        #torch.save(each_iteration_best_model_list, './model/masc_paragraph_addposnerembedding_dictformat_BiLSTMCRF_eachiteration_adam0.001_'+ 'l2'+ str(parameters['weight_decay']) + '_sen' + parameters['sentence_embedding_type']+ '_senzero'+ str(parameters['sentence_zero_inithidden'])+ '_layer' +  str(parameters['num_layers']) + '_batch' + str(parameters['batch_size']) +  '_hidden'+ str(parameters['hidden_size'])  + '_addoutputdropout' + str(parameters['dropout']) + '.pt')
        #torch.save(overall_best_model.state_dict(), './model/masc_paragraph_addposnerembedding_dictformat_BiLSTMCRF_bestmodel_adam0.001_'+ 'l2'+ str(parameters['weight_decay']) + '_sen' + parameters['sentence_embedding_type']+ '_senzero'+ str(parameters['sentence_zero_inithidden'])+ '_layer' +  str(parameters['num_layers']) + '_batch' + str(parameters['batch_size']) +  '_hidden'+ str(parameters['hidden_size'])  + '_addoutputdropout' + str(parameters['dropout']) + '.pt')
